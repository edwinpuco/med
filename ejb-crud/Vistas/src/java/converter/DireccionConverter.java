...
@FacesConverter(value = "direccionConverter")
public class DireccionConverter implements Converter {

    private DireccionFacade ejbFacade;
    ...
    private DireccionFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(DireccionFacade.class).get();
